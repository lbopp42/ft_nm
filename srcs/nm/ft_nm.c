...
/*   Updated: 2019/03/20 10:11:15 by lbopp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_nm(char *ptr)
{
	...
	else if (magic_number == FAT_MAGIC || magic_number == FAT_CIGAM)
	{
		...
		printf("HERE\n");
		if (fat_header->magic == FAT_MAGIC || fat_header->magic == FAT_CIGAM)
			printf("SI c'est good\n");
